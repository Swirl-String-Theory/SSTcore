...
#!/usr/bin/env python3
"""
Example: build a simple 3D knot curve, extract a PD via sstcore.pd_from_curve,
then compute (or attempt) the hyperbolic volume via sstcore.hyperbolic_volume_from_pd.
