...
double SpectroscopicGap::kelvin_gap_joule(double hbar, double v_swirl, double r_c, double multiplier) {
...
double SpectroscopicGap::joule_to_ev(double E_joule) {
    return E_joule / static_cast<double>(SST::Constants::E_CHARGE);
}

double SpectroscopicGap::ev_to_joule(double E_ev) {
    return E_ev * static_cast<double>(SST::Constants::E_CHARGE);
}

double SpectroscopicGap::kelvin_gap_ev(double hbar, double v_swirl, double r_c, double multiplier) {
    return joule_to_ev(kelvin_gap_joule(hbar, v_swirl, r_c, multiplier));
}

double SpectroscopicGap::boltzmann_suppression(double gap_joule, double temperature_K, double k_B) {
...
bool SpectroscopicGap::is_decoupled_from_atomic_transition(double transition_ev, double gap_ev, double safety_factor) {
...
double SpectroscopicGap::gap_ratio(double transition_ev, double gap_ev) {
