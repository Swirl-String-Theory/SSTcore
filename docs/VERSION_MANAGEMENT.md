...
- `setup.py`: `__version__ = "0.8.25"`
- `src/SSTcore/__init__.py`: `__version__ = "0.8.25"`
- `include/sstcore_version.h`: `SSTCORE_VERSION` / `SSTCORE_CANON_VERSION` = `"0.8.25"`
- `package.json`: `"version": "0.8.25"`
