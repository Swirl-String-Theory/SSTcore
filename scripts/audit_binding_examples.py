...
MODULE_TO_EXAMPLES: Dict[str, Tuple[str, ...]] = {
    ...
    "density_ontology": ("example_density_ontology.py",),
    "rotor_participation": ("example_density_ontology.py",),
    "scaling_audit": ("example_density_ontology.py",),
    "worldsheet_guards": ("example_maxwell_canon.py",),
    "ideal_knot_regime": ("example_maxwell_canon.py",),
    "transverse_projector": ("example_maxwell_canon.py",),
    "spectro_response": ("example_maxwell_canon.py",),
    "maxwell_kinetic": ("example_maxwell_canon.py",),
    "mechanical_falsifier": ("example_maxwell_canon.py",),
    "swirl_tonic": ("example_maxwell_canon.py",),
}
